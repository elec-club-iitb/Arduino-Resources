/*
  ...
  This program  will read from one ADC channel an analog value or voltage generated by LM35 temperature sensor.
...
int itemp; // define variables for ADC count, actual voltage measured in mV and actual temperature
...
void loop() {
  ...
  itemp = analogRead(temp_sensor_Pin);// note itemp is an int and may have a range of 0 to 1023. 
